...
def test_coml_user_intention():
    ...
    # coml_agent("Train a ML model with rpart.preproc algorithm for MNIST dataset, a dataset of handwritten digits.", X, y)
    # coml_agent("Use glmnet algorithm to fit to a MNIST dataset, a dataset of handwritten digits.")
    # coml_agent("Get a dataset to pretrain the model.", "BERT()")
    coml_agent("The task is to predict the final price of each home, given 79 explanatory variables describing (almost) every aspect "
        "of residential homes in Ames, Iowa. I want to use xgboost Regressor. How to configure its hyper-parameters?")
