...
import { CoMLPanel } from "./panels/CoMLPanel";
...
export function activate(context: vscode.ExtensionContext) {	
	...
	const showHelloWorldCommand = vscode.commands.registerCommand("coml.showHelloWorld", () => {
		CoMLPanel.render(context.extensionUri);
	});
